...
import { modifiedAnnance } from "../../js/actions/annanceAction";
...
const Modannance = () => {
  ...
  const [point_depart, setPoint_depart] = useState("annances.point_depart");
  const [point_darriver, setPoint_darriver] = useState("annances.point_darriver");
  const [descreption, setDescreption] = useState("annances.descreption");
  const [date_depart, setDate_depart] = useState("annances.date_depart");
  const [Nbr_place, setNbr_place] = useState("annances.Nbr_place");
  const [voiture, setVoiture] = useState("annance.voiture");
  const [phone, setPhone] = useState("annance.phone");
  ...
  return (
    <div className="spanne">
      <h1>SVP modifier votre annance de covoiturage</h1>
